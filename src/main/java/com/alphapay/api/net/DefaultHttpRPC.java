...
import com.alphapay.api.ssl.TrueHostnameVerifier;
import com.alphapay.api.ssl.X509TrustManagerImp;
...
public class DefaultHttpRPC {
    ...
    public static HttpRpcResult doPost(String url, Map<String, String> header, String reqBody) throws IOException, AlphaPayApiException {
    ...
    private static HttpRpcResult doPost(String url, String ctype, Map<String, String> reqHeader, byte[] content) throws IOException, AlphaPayApiException {
        ...
        try {
            ...
            try {
                ...
                httpRpcResult.setRspNonce(getResponseNonce(conns));
    ...
    private static HttpsURLConnection getConnection(URL url, String method, String ctype) throws IOException, AlphaPayApiException {
        ...
        if (Constants.SCHEME.equalsIgnoreCase(url.getProtocol())) {
            ...
            throw new AlphaPayApiException("Only supports HTTPS.");
        }
...
//        connHttps.setRequestProperty(Constants.ACCEPT_HEADER, "text/plain,text/xml,text/javascript,text/html");
        connHttps.setRequestProperty(Constants.ACCEPT_HEADER, ctype);
        connHttps.setRequestProperty(Constants.USER_AGENT_HEADER, "openapi-sdk-java");
    ...
    public static String getResponseNonce(HttpsURLConnection conn) {
        String nonce = conn.getHeaderField(Constants.RSP_NONCE_HEADER);
        return nonce;
    }
